...
namespace MudBlazor.Markdown.Tests
{
	public sealed class MudMarkdownTests : MudMarkdownTestsBase
	{
		...
		public void RenderCodeItalicAndBold()
		{
			...
			const string expectedValue = "<p class=\"mud-typography mud-typography-body1 mud-inherit-text\">Some text <code>code</code> again text - <i>italics</i> text and <b>bold</b> text.</p>";
