...
public sealed class MarkdownComponentSourceShould : MarkdownComponentTestsBase
{
			...
			$"""
			 <article id:ignore class="mud-markdown-body">
			   <p class="mud-typography mud-typography-body1">
			     Error while reading from file, path=<code>Resources{Path.DirectorySeparatorChar}i dont exist.md</code>, error=<code>Could not find file 'path'.</code>
			   </p>
			   <div class="hljs mud-markdown-code-highlight">
			     ...
			     <pre><code class="hljs language-txt">System.IO.FileNotFoundException: Could not find file 'path'.
			 File name: 'path'
			    :callstack:</code></pre>
			   </div>
			 </article>
	...
	public void RenderValueFromInvalidUrl()
	{
		...
		const string expected =
			...
			<article id:ignore class="mud-markdown-body">
			  <p class="mud-typography mud-typography-body1">
			    Error while reading from URL, URL=<code>invalid url</code>, error=<code
			      >An invalid request URI was provided. Either the request URI must be an absolute URI or BaseAddress must be
			      set.</code
			    >
			  </p>
			  <div class="hljs mud-markdown-code-highlight">
			    ...
			    <pre><code class="hljs language-txt">System.InvalidOperationException: An invalid request URI was provided. Either the request URI must be an absolute URI or BaseAddress must be set.
			   :callstack:</code></pre>
			  </div>
			</article>
			""";
